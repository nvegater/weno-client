...
export type ExperienceInfoFragment = {
  createdAt: any;
  id: number;
  title: string;
  description: string;
...
export type ExperienceListItemFragment = {
  id: number;
  title: string;
  experienceType: ExperienceType;
  imageCount: number;
...
export type GetImageFragment = {
  id: number;
  imageName: string;
  getUrl: string;
};

export type PaginatedExperienceFragment = {
  createdAt: any;
  id: number;
  title: string;
  description: string;
  ...
  wineryId: number;
  wineryName: string;
  allAttendeesAllSlots?: number | null | undefined;
  experienceType: ExperienceType;
  valley?: Valley | null | undefined;
  images?:
    | Array<{ id: number; imageName: string; getUrl: string }>
    | null
    | undefined;
  slots: Array<{
    id: number;
    ...
    noOfAttendees?: number | null | undefined;
    slotType: SlotType;
    createdAt: any;
    updatedAt: any;
  }>;
...
export type PaginationResultFragmentFragment = {
...
export type PreSignedUrlFragment = {
...
export type SlotFragmentFragment = {
  id: number;
  startDateTime: any;
  endDateTime: any;
  durationInMinutes: number;
...
export type TiersFragmentFragment = {
  flat_amount?: number | null | undefined;
  flat_amount_decimal?: string | null | undefined;
  unit_amount?: number | null | undefined;
  unit_amount_decimal?: string | null | undefined;
...
export type WineryFragmentFragment = {
  id: number;
  name: string;
  urlAlias: string;
  stripe_customerId?: string | null | undefined;
  subscription?: string | null | undefined;
  accountId?: string | null | undefined;
  accountCreatedTime?: number | null | undefined;
  creatorUsername: string;
  creatorEmail: string;
  description: string;
  foundationYear?: number | null | undefined;
  googleMapsUrl?: string | null | undefined;
  yearlyWineProduction?: number | null | undefined;
  covidLabel?: boolean | null | undefined;
  productionType?: Array<ProductionType> | null | undefined;
  valley: Valley;
  wineType?: Array<TypeWine> | null | undefined;
  supportedLanguages?: Array<ServiceLanguage> | null | undefined;
  amenities?: Array<Amenity> | null | undefined;
  createdAt: any;
  updatedAt: any;
};

export type WineryConfirmationFragmentFragment = {
  id: number;
  name: string;
  urlAlias: string;
  creatorEmail: string;
...
export type AddImageToExperienceMutation = {
...
export type EditExperienceMutation = {
  editExperience: {
    successfulEdit?: boolean | null | undefined;
    errors?: Array<{ field: string; message: string }> | null | undefined;
  };
};
...
export type CreateExperienceMutation = {
  createExperience: {
    ...
    experience?:
      ...
      | undefined;
    dateWithTimes?:
      | Array<{ date: any; durationInMinutes: number; times: Array<any> }>
      | null
      | undefined;
  };
};
...
export type CreateWineryMutation = {
  createWinery: {
...
export type EditWineryInfoMutation = {
  editWinery: {
    errors?: Array<{ field: string; message: string }> | null | undefined;
    winery?:
      | {
...
export type GetCheckoutLinkMutation = {
  getCheckoutLink: {
...
export type GetPresignedUrlsMutation = {
  preSignedUrl: {
    arrayUrl?:
      | Array<{
          getUrl?: string | null | undefined;
...
export type WineryOnboardingMutation = {
  wineryOnboarding: {
    accountLinkUrl?: string | null | undefined;
    errors?: Array<{ field: string; message: string }> | null | undefined;
  };
};
...
export type RecurrentDatesQuery = {
  recurrentDates: {
    dateWithTimes?: Array<{ date: any; times: Array<any> }> | null | undefined;
    errors?: Array<{ field: string }> | null | undefined;
  };
};
...
export type CustomerReservationsQuery = {
...
export type ExperiencesQuery = {
  experiences: {
    totalExperiences?: number | null | undefined;
    errors?: Array<{ field: string; message: string }> | null | undefined;
    experiences?:
      | Array<{
          createdAt: any;
...
export type ExperiencesListQuery = {
  experiencesList: {
    errors?: Array<{ field: string; message: string }> | null | undefined;
    experiencesList?:
      | Array<{
...
export function useEditExperienceMutation() {
  return Urql.useMutation<
    ...
    EditExperienceMutationVariables
  >(EditExperienceDocument);
}
...
export function useConfirmConnectedAccountMutation() {
  return Urql.useMutation<
    ConfirmConnectedAccountMutation,
    ConfirmConnectedAccountMutationVariables
  >(ConfirmConnectedAccountDocument);
}
...
export function useCreateWineryMutation() {
  return Urql.useMutation<CreateWineryMutation, CreateWineryMutationVariables>(
    CreateWineryDocument
  );
}
...
export function useEditWineryInfoMutation() {
  return Urql.useMutation<
    EditWineryInfoMutation,
    EditWineryInfoMutationVariables
  >(EditWineryInfoDocument);
}
...
export function useGetPresignedUrlsMutation() {
  return Urql.useMutation<
    GetPresignedUrlsMutation,
    GetPresignedUrlsMutationVariables
...
export function useSaveImagesMutation() {
  return Urql.useMutation<SaveImagesMutation, SaveImagesMutationVariables>(
    SaveImagesDocument
  );
}
...
export function useWineryOnboardingMutation() {
  return Urql.useMutation<
    WineryOnboardingMutation,
    WineryOnboardingMutationVariables
  >(WineryOnboardingDocument);
}
export const RecurrentDatesDocument = gql`
  query RecurrentDates(
    $createRecurrentDatesInputs: CreateRecurrentDatesInputs!
  ) {
...
export function useRecurrentDatesQuery(
  options: Omit<Urql.UseQueryArgs<RecurrentDatesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<RecurrentDatesQuery>({
    query: RecurrentDatesDocument,
    ...options,
  });
}
...
export function useAllWineryNamesQuery(
  options: Omit<Urql.UseQueryArgs<AllWineryNamesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<AllWineryNamesQuery>({
    query: AllWineryNamesDocument,
    ...options,
  });
}
...
export function useCustomerReservationsQuery(
  options: Omit<
    Urql.UseQueryArgs<CustomerReservationsQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<CustomerReservationsQuery>({
    query: CustomerReservationsDocument,
    ...options,
  });
}
...
export function useExperiencesQuery(
  options: Omit<Urql.UseQueryArgs<ExperiencesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<ExperiencesQuery>({
...
export function useExperiencesListQuery(
  options: Omit<Urql.UseQueryArgs<ExperiencesListQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<ExperiencesListQuery>({
    query: ExperiencesListDocument,
    ...options,
  });
}
...
export function useGetSubscriptionStatusQuery(
  options: Omit<
    Urql.UseQueryArgs<GetSubscriptionStatusQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<GetSubscriptionStatusQuery>({
...
export function useReservedSlotsQuery(
  options: Omit<Urql.UseQueryArgs<ReservedSlotsQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<ReservedSlotsQuery>({
    query: ReservedSlotsDocument,
    ...options,
  });
}
...
export function useSubscriptionProductsQuery(
  options: Omit<
    Urql.UseQueryArgs<SubscriptionProductsQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<SubscriptionProductsQuery>({
    query: SubscriptionProductsDocument,
    ...options,
  });
}
...
export function useGetCheckoutSessionStatusQuery(
  options: Omit<
    Urql.UseQueryArgs<GetCheckoutSessionStatusQueryVariables>,
    "query"
  > = {}
) {
  return Urql.useQuery<GetCheckoutSessionStatusQuery>({
    query: GetCheckoutSessionStatusDocument,
    ...options,
  });
}
...
export function useWineryQuery(
  options: Omit<Urql.UseQueryArgs<WineryQueryVariables>, "query"> = {}
) {
...
export function useWineryImagesQuery(
  options: Omit<Urql.UseQueryArgs<WineryImagesQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<WineryImagesQuery>({
    query: WineryImagesDocument,
    ...options,
  });
}
